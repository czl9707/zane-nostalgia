...
const SceneComponents = {
    "404": dynamic(async () => import(`../../scene-components/404`).then(m => m.Component), { ssr: false }),
    "meteors": dynamic(async () => import(`../../scene-components/meteors`).then(m => m.Component), { ssr: false }),
    "waves": dynamic(async () => import(`../../scene-components/waves`).then(m => m.Component), { ssr: false }),
    "rainy": dynamic(async () => import(`../../scene-components/rainy`).then(m => m.Component), { ssr: false }),
    "noise": dynamic(async () => import(`../../scene-components/noise`).then(m => m.Component), { ssr: false }),
    "beats": dynamic(async () => import(`../../scene-components/beats`).then(m => m.Component), { ssr: false }),
    "cubes": dynamic(async () => import(`../../scene-components/cubes`).then(m => m.Component), { ssr: false }),
} as const;
