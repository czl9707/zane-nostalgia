...
interface RainyMeta extends CommonMetaData {
...
function Rainy({
    ...
    width,
    geoSeed,
}: Scene.RawComponentProps<RainyMeta>) {
...
const rainyModule: Scene.ComponentModule<RainyMeta> = {
    Icon: LightRainyIcon,
    name: "Rainy",
    route: "rainy",
    meta: rainyMeta,
    Component: ParamsResolvingWrapper(Rainy, rainyMeta),
}
