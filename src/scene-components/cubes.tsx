...
interface CubesMeta extends CommonMetaData {
...
function Cubes({
    ...
    width,
    geoSeed,
}: Scene.RawComponentProps<CubesMeta>) {
...
const cubesModule: Scene.ComponentModule<CubesMeta> = {
    Icon: CubeIcon,
    name: "Cubes",
    route: "cubes",
    meta: cubesMeta,
    Component: ParamsResolvingWrapper(Cubes, cubesMeta),
}
