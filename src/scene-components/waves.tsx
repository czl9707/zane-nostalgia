...
interface WavesMeta extends CommonMetaData {
...
function Waves({
    ...
    width,
    geoSeed,
}: Scene.RawComponentProps<WavesMeta>) {
...
const wavesModule: Scene.ComponentModule<WavesMeta> = {
    Icon: WaterIcon,
    name: "Waves",
    route: "waves",
    meta: wavesMeta,
    Component: ParamsResolvingWrapper(Waves, wavesMeta),
}
